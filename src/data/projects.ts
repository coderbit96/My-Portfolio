...
export const projects: Project[] = [
  {
    ...
    slug: "showtime",
    title: "ShowTime",
    shortDescription: "A TypeScript cinema-style interface for browsing and discovering shows.",
    ...
    features: ["Cinema-style browsing interface", "Responsive viewing experience", "Public source code and live deployment"],
  ...
  },
  {
    ...
    shortDescription: "A TypeScript dashboard for managing student records and academic workflows.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
  ...
  },
  {
    ...
    shortDescription: "A responsive turf-booking website for exploring and reserving sports slots.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
    thumbnail: "",
    images: [],
    category: "Other",
  ...
  },
  {
    ...
    slug: "ecommerce",
    title: "Ecommerce",
    shortDescription: "A TypeScript storefront for browsing products and completing a simple shopping flow.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
  ...
  },
  {
    ...
    shortDescription: "A motion-led personal site for showcasing work, skills, and contact details.",
  ...
  },
  {
    ...
    slug: "rasoigo",
    title: "RasoiGo",
    shortDescription: "A food discovery interface for browsing dishes, menus, and restaurant-style content.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
  ...
  },
  {
    ...
    shortDescription: "A TypeScript dashboard for organizing employee records and workplace tasks.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
  ...
  },
  {
    ...
    shortDescription: "Convert currencies with live rates, offline fallback data, and recent history.",
    ...
    year: "2026",
    status: "Live",
    problem: "ShowTime presents a focused viewing interface for exploring a cinema-inspired web experience.",
    solution: "The project uses TypeScript to organise a responsive interface that can be reviewed through its public source and live deployment.",
    challenges: [],
  ...
  },
  {
    ...
    slug: "atmos",
    title: "ATMOS",
    shortDescription: "A TypeScript web experience with a custom responsive interface.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
    thumbnail: "",
    images: [],
    category: "Other",
    technologies: ["TypeScript"],
    features: ["Student-focused management interface", "Responsive dashboard experience", "Public source code and live deployment"],
    liveUrl: "https://atmos-smoky.vercel.app",
    githubUrl: "https://github.com/coderbit96/ATMOS",
    featured: false,
    year: "2026",
    status: "Live",
    problem: "Student Management System explores a clearer way to present student-management workflows in a web interface.",
    solution: "Joydip implemented the project in TypeScript with a responsive dashboard-style experience available to review online.",
    challenges: [],
  ...
  },
  {
    ...
    slug: "tour-expenses",
    title: "Tour Expenses",
    shortDescription: "A TypeScript expense tracker for planning travel budgets and recording costs.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
    thumbnail: "",
    images: [],
    category: "Dashboard",
    technologies: ["TypeScript"],
    features: ["E-commerce user interface", "Responsive marketplace experience", "Public source code and live deployment"],
    liveUrl: "https://tour-expenses.vercel.app",
    githubUrl: "https://github.com/coderbit96/Tour-Expenses",
    featured: false,
    year: "2026",
    status: "Live",
    problem: "Ecommerce explores an approachable online-shopping interface with a clear visual path through the experience.",
    solution: "The TypeScript implementation is published with a live deployment so the interface and source can be reviewed directly.",
    challenges: [],
  ...
  },
  {
    ...
    slug: "arcade-games",
    title: "Arcade Games",
    shortDescription: "A TypeScript collection of quick, browser-based arcade games.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
    thumbnail: "",
    images: [],
    category: "Other",
    technologies: ["TypeScript"],
    features: ["Food-focused browsing interface", "Responsive web experience", "Public source code and live deployment"],
    liveUrl: "https://arcade-games-topaz.vercel.app",
    githubUrl: "https://github.com/coderbit96/Arcade-Games",
    featured: false,
    year: "2026",
    status: "Live",
    problem: "RasoiGo explores a food-focused digital experience that makes menu-style content easier to browse.",
    solution: "Joydip built the TypeScript project as a responsive web experience with publicly available source and deployment links.",
    challenges: [],
  ...
  },
  {
    ...
    slug: "durga",
    title: "Durga",
    shortDescription: "A custom TypeScript web experience with a responsive user interface.",
    description: "Open the repository and live deployment to explore the available code, interface, and documentation.",
    thumbnail: "",
    images: [],
    category: "Other",
    technologies: ["TypeScript"],
    features: ["Employee-focused management interface", "Responsive dashboard experience", "Public source code and live deployment"],
    liveUrl: "https://durga-eight.vercel.app",
    githubUrl: "https://github.com/coderbit96/Durga",
    featured: false,
    year: "2026",
    status: "Live",
    problem: "Employee Management System explores a clearer web interface for employee-management workflows.",
    solution: "The TypeScript project is delivered as a responsive dashboard-style experience with source and a public deployment for review.",
    challenges: [],
  ...
  },
  {
    ...
    shortDescription: "A personalised Bengali invitation with guest content, gallery, motion, and music.",
    ...
    year: "2026",
    status: "Live",
    problem: "Currency conversion can be difficult when people need current reference rates, searchable currencies, and a useful fallback when connectivity is limited.",
    solution: "Joydip built a React currency converter that combines Frankfurter API reference rates with searchable selectors, cached fallback data, and recent conversion history.",
    challenges: [],
  ...
  },
  {
    ...
    shortDescription: "Create and share animated birthday wishes with private message storage.",
  ...
  },
  {
    ...
    shortDescription: "An AI workspace for chat, code and image generation, and project summaries.",
  ...
  },
  {
    ...
    slug: "career-pilot",
    title: "Career Pilot",
    shortDescription: "An AI career platform for guided career-development workflows.",
  ...
  },
  {
    ...
    shortDescription: "A conversion-focused business landing page with lead capture, pricing, and FAQs.",
  ...
  },
  {
    ...
    shortDescription: "An education website concept with simple navigation and a clear content structure.",
  ...
  },
  {
    ...
    shortDescription: "A lightweight personal website for skills, work, and contact details.",
  ...
  },
  {
    ...
    shortDescription: "A quick browser game with instant results and score tracking.",
