...
export const metadata: Metadata = {
  ...
  description:
    "Preview and download the resume of Joydip Ghosh, a Full Stack Developer based in Kolkata, India.",
  alternates: {
    canonical: "/resume"
  },
  openGraph: {
    ...
    description:
      "Preview the professional resume of Joydip Ghosh, Full Stack Developer in Kolkata.",
    url: "/resume",
    type: "profile",
    images: [
      {
